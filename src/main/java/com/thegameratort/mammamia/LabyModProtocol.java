...
public class LabyModProtocol {
    ...
    private static final MinecraftKey labyModKey = new MinecraftKey("labymod3:main");
    ...
    public static void sendLabyModMessage(Player player, String key, JsonElement messageContent ) {
        ...
        PacketPlayOutCustomPayload payloadPacket = new PacketPlayOutCustomPayload( labyModKey , pds );
